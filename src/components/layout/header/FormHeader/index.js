                            ...
                            <Popover>
                                {({ open }) => (
                                    <>
                                        ...
                                        >
                                            <span><NextLink href={token ? "/company-dashboard/all-apply-user" : "/company-login"} className='no-underline text-[#000] hover:text-gray-700'>Applied User</NextLink></span>
                                        </div>
                                    </>
                                )}
                            </Popover>
                                        ...
                                        >
                                            <div className='revative'>
                                                ...
                                                <div className='absolute top-16 z-20 bg-[#fff]  border-2 rounded-md shadow-lg '>
                                                    {
                                                        value && <ul>
                                                            <li className='hover:bg-slate-300  px-5 py-1 text-[#000] hover:text-[#000] '><NextLink href={ token ? "/view-job" : "/company-login"} className='' >Job</NextLink></li>
                                                            <li className='hover:bg-slate-300  px-5 py-1 text-[#000] hover:text-[#000] '><NextLink href={ token ? "/view-internship" : "/company-login"}  className='' >internship</NextLink></li>
                                                        </ul>
                                                    }
                                                </div>
                                            </div>
                            ...
                            <Popover>
                                {({ open }) => (
                                    <>
                                        ...
                                        >
                                            <span><NextLink href="/contact-company" className='no-underline text-[#000] hover:text-gray-700'>Contact</NextLink></span>
