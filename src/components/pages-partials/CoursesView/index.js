        ...
        <div className='mainfac grid sm:grid-cols-2 place-content-center flex '>
          {
           data[0] ?  data.map((val) => {
                ...
                <>
                  <div className='d1 md:ml-[70px]'>
                    <div className='relative flex'>
                      <div className=' absolute z-20  w-[130px] h-[130px] flex items-center top-1  xl:lg:md:left-[-20px]'>
                       { val.teacher_profile ? <img src={val.teacher_profile} alt="teacherdata" className='w-[110px] h-[110px] rounded-full border-[4px] border-[#212A41]'></img> : <img src="/img/Rectangle 7.png" alt="" className='w-[110px] h-[110px] rounded-full border-[4px] border-[#212A41]'/>} 
                      </div>
                      <div className='flex flex-col items-center  ml-[50px] py-5 rounded'>
                        ...
                        <div className='teadetail px-3 py-3 bg-[#EFEFEF]  w-[340px] h-[340px]  shadow ml-[-20px]'>
                          ...
                          <hr></hr>
                          <div className='stud flex gap-3 max-h-[140px] text-ellipsis overflow-hidden'>
                            <p> {val.description}</p>
                          </div>
                          <div className='learnmore text-center mt-[20px]'>
                            <NextLink href={`/shorterm-course/sortterm-course-detail/${val._id}`} onClick={() => {localStorage.setItem("courseId", val._id),localStorage.setItem("fees",val.fees)}}><button className='bg-[#3DC0DF] text-[#fff] uppercase rounded px-2 py-2 hover:bg-[white] hover:text-[#3DC0DF] hover:border hover:border-[#3DC0DF]'>Learn More</button></NextLink>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            })  : <div className='text-center text-[30px] col-span-2 py-32'>No Course </div>
          }
        </div>
