            ...
            <div className='max-w-2xl mx-auto px-5 lg:justify-start px-10 pt-[70px] border rounded my-[150px]'>
                <div className='space-y-6'>
                    ...
                    <div className=''>
                        ...
                        <input type="password" className='rounded-3xl bg-[#DBDBDB] form-control w-[100%] border-t-0 border-l-0 border-r-0 border-b-0' name="newPassword" onChange={handleInput} value={data.newPassword} />
                    </div>
                    <div className=''>
                        <label className='mx-3  text-[18px] font-semibold'>Retype password*</label><br></br>
                        <input type="password" className='rounded-3xl bg-[#DBDBDB] form-control w-[100%] border-t-0 border-l-0 border-r-0 border-b-0' name='confirmPassword' onChange={handleInput} value={data.confirmPassword} />
                    </div>
